...
@WebAppConfiguration
@SpringBootTest
public class ChangeClientServiceImplTest {
	...
	public void testGetOptimalChangeFor() throws Exception {
		Collection<Coin>coins = changeClientServiceImpl.getOptimalChangeFor(576);
		assertTrue(coins.size() == 3);
	}

	@Test
	public void testGetSupplyChangeFor() throws Exception {
		Collection<Coin>coins = changeClientServiceImpl.getChangeFor(2896);
